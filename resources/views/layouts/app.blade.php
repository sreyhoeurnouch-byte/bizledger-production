    ...
    <div class="container-fluid px-3 px-lg-4">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav me-auto mb-2 mb-xl-0">
                ...
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle {{ request()->routeIs('customers.*','sales.*') ? 'active' : '' }}" href="#" data-bs-toggle="dropdown">Customer</a><div class="dropdown-menu app-menu"><a class="dropdown-item" href="{{ route('customers.index') }}"><span class="menu-mark"><i class="fa-solid fa-users" aria-hidden="true"></i></span><span><strong>Customer center</strong><small>Customers and receivables</small></span></a><a class="dropdown-item" href="{{ route('sales.index') }}"><span class="menu-mark"><i class="fa-solid fa-cart-arrow-down" aria-hidden="true"></i></span><span><strong>Sales orders</strong><small>Deliver, invoice, and collect</small></span></a></div></li>
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle {{ request()->routeIs('purchasing.*','payables.*','accounting.*') ? 'active' : '' }}" href="#" data-bs-toggle="dropdown">Finance</a><div class="dropdown-menu app-menu"><a class="dropdown-item" href="{{ route('purchasing.index') }}"><span class="menu-mark"><i class="fa-solid fa-cart-shopping" aria-hidden="true"></i></span><span><strong>Purchase orders</strong><small>Plan and receive supplier orders</small></span></a><a class="dropdown-item" href="{{ route('payables.index') }}"><span class="menu-mark"><i class="fa-solid fa-file-invoice-dollar" aria-hidden="true"></i></span><span><strong>Vendor bills</strong><small>Track payables and payments</small></span></a><a class="dropdown-item" href="{{ route('accounting.index') }}"><span class="menu-mark"><i class="fa-solid fa-book" aria-hidden="true"></i></span><span><strong>Chart of accounts</strong><small>Accounts and opening balances</small></span></a></div></li>
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle {{ request()->routeIs('reports.*') ? 'active' : '' }}" href="#" data-bs-toggle="dropdown">Report</a><div class="dropdown-menu app-menu"><a class="dropdown-item" href="{{ route('reports.stock') }}"><span class="menu-mark"><i class="fa-solid fa-chart-pie" aria-hidden="true"></i></span><span><strong>Stock valuation</strong><small>Inventory quantity and value</small></span></a><a class="dropdown-item" href="{{ route('reports.receivables') }}"><span class="menu-mark"><i class="fa-solid fa-clock" aria-hidden="true"></i></span><span><strong>Receivables aging</strong><small>Outstanding customer invoices</small></span></a><a class="dropdown-item" href="{{ route('reports.payables') }}"><span class="menu-mark"><i class="fa-solid fa-money-bill-transfer" aria-hidden="true"></i></span><span><strong>Payables aging</strong><small>Outstanding supplier bills</small></span></a></div></li>
            </ul>
